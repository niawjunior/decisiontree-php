        ...
        <nav  class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="index.php"><i class="fa fa-magic fa-3x"></i> ต้นไม้ตัดสินใจ 1</a>
                    </li>
                     <li>
                        <a class=""  href="index2.php"><i class="fa fa-magic fa-3x"></i> ต้นไม้ตัดสินใจ 2</a>
                    </li>
                </ul>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="desktop" name="desktop">
                                                <option value=""></option>
                                                <option value="YES">YES</option>
                                                <option value="NO">NO</option>
                                            </select>
